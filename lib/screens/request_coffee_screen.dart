    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Hero(
            tag: widget.cItem['thumbnail'],
            child: Container(
              height: (screenHeight / 2) - 20.0,
              width: screenWidth,
              decoration: BoxDecoration(
                image: DecorationImage(image: NetworkImage(widget.cItem['thumbnail']), fit: BoxFit.cover),
              ),
            ),
          ),
          Positioned(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            widget.cItem['ingredients_with_bar']!,
                            style: GoogleFonts.sourceSans3(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 10.0),
                        RequestCoffee(cItem: widget.cItem)
                      ],
                    )
                  ],
                ),
